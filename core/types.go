...
type PageRestaurantSpecialties struct {
	Breakfast uint32 `json:"breakfast"`
	Coffee    uint32 `json:"coffee"`
	Dinner    uint32 `json:"dinner"`
	Drinks    uint32 `json:"drinks"`
	Lunch     uint32 `json:"lunch"`
}
...
type Page struct {
	...
	PromotionEligibleReason      string                    `json:"promotion_eligible_reason"`
	PublicTransit                string                    `json:"public_transit"`
	PublisherSpace               interface{}               `json:"publisher_space"`
	RatingCount                  uint32                    `json:"rating_count"`
	Recipient                    string                    `json:"recipient"`
	RecordLabel                  string                    `json:"record_label"`
	ReleaseDate                  string                    `json:"release_date"`
	RestaurantServices           PageRestaurantServices    `json:"restaurant_services"`
	RestaurantSpecialties        PageRestaurantSpecialties `json:"restaurant_specialties"`
	Scheldue                     string                    `json:"scheldue"`
	...
	StartInfo                    PageStartInfo             `json:"start_info"`
	...
	TalkingAboutCount            uint32                    `json:"talking_about_count"`
	UnreadMessageCount           uint32                    `json:"unread_message_count"`
	UnreadNotifCount             uint32                    `json:"unread_notif_count"`
	UnseenMessageCount           uint32                    `json:"unseen_message_count"`
	Username                     string                    `json:"username"`
	VerificationStatus           string                    `json:"verification_status"`
	VOIPInfo                     VOIPInfo                  `json:"voip_info"`
	Website                      string                    `json:"website"`
	WhereHereCount               uint32                    `json:"where_here_count"`
